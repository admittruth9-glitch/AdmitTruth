...
const telanganaColleges: College[] = [
  ...
  // === COMPREHENSIVE TELANGANA COLLEGES DATASET ===
  {
    name: "Indian Institute of Technology Hyderabad", code: "IITH", location: "Kandi, Sangareddy", district: "Sangareddy",
    type: "IIT", rating: 5, brochureRating: 5, realityRating: 5,
    realityReason: "Strong research, modern campus, excellent placements.",
    bitterTruth: "Remote location, still expanding, hot summers.",
    avgPackage: 20, highestPackage: 150, placementRate: 92, fees: 2.2,
    jeeAdvancedRankCutoff: 500, jeePercentileCutoff: 99.7,
    branches: ["CSE", "AI", "Electrical", "Mechanical", "Civil", "Chemical", "Engineering Physics"],
    sentiment: { positive: 88, negative: 5, neutral: 7 }, tier: "dream",
    naacGrade: "A++", nirfRank: 8, establishedYear: 2008
  },
  {
    name: "National Institute of Technology Warangal", code: "NITW", location: "Warangal", district: "Hanamkonda",
    type: "NIT", rating: 5, brochureRating: 5, realityRating: 4.8,
    realityReason: "Old NIT with strong alumni network and placements.",
    bitterTruth: "Hostel food is legendary for wrong reasons. Strict attendance.",
    avgPackage: 18, highestPackage: 120, placementRate: 90, fees: 1.8,
    jeePercentileCutoff: 98.5,
    branches: ["CSE", "ECE", "EEE", "Mechanical", "Civil", "Chemical", "Biotech"],
    sentiment: { positive: 85, negative: 8, neutral: 7 }, tier: "dream",
    naacGrade: "A+", nirfRank: 21, establishedYear: 1959
  },
  {
    name: "International Institute of Information Technology Hyderabad", code: "IIITH", location: "Gachibowli, Hyderabad", district: "Hyderabad",
    type: "IIIT", rating: 5, brochureRating: 5, realityRating: 5,
    realityReason: "Research powerhouse in CS, great placements, flexible curriculum.",
    bitterTruth: "Expensive fees, high workload, campus is small.",
    avgPackage: 25, highestPackage: 200, placementRate: 95, fees: 3.5,
    jeePercentileCutoff: 99.5,
    branches: ["CSE", "AI", "Data Science", "Electronics", "Computational Linguistics"],
    sentiment: { positive: 92, negative: 4, neutral: 4 }, tier: "dream",
    naacGrade: "A+", nirfRank: 55, establishedYear: 1998
  },
  {
    name: "Osmania University", code: "OU", location: "Hyderabad", district: "Hyderabad",
    type: "State", rating: 4.5, brochureRating: 4.5, realityRating: 4,
    realityReason: "Historic university with decent engineering campus placements.",
    bitterTruth: "Bureaucracy, old infrastructure in some departments.",
    avgPackage: 6, highestPackage: 30, placementRate: 75, fees: 0.5,
    jeePercentileCutoff: 95,
    branches: ["CSE", "ECE", "EEE", "Mechanical", "Civil"],
    sentiment: { positive: 75, negative: 15, neutral: 10 }, tier: "best-fit",
    naacGrade: "A+", nirfRank: 36, establishedYear: 1918
  },
  {
    name: "Jawaharlal Nehru Technological University Hyderabad", code: "JNTUH", location: "Hyderabad", district: "Hyderabad",
    type: "State", rating: 4.5, brochureRating: 4.5, realityRating: 4,
    realityReason: "Affordable, good placements for top branches.",
    bitterTruth: "Massive intake dilutes quality, strikes can disrupt schedule.",
    avgPackage: 7, highestPackage: 40, placementRate: 80, fees: 0.6,
    jeePercentileCutoff: 96,
    branches: ["CSE", "ECE", "EEE", "Mechanical", "Civil", "IT"],
    sentiment: { positive: 78, negative: 12, neutral: 10 }, tier: "best-fit",
    naacGrade: "A+", nirfRank: 62, establishedYear: 1972
  },
  {
    name: "JNTUH College of Engineering Hyderabad", code: "JNTUHCEH", location: "Hyderabad", district: "Hyderabad",
    type: "State", rating: 4.2, brochureRating: 4.3, realityRating: 4,
    realityReason: "Flagship JNTUH campus, decent placements.",
    bitterTruth: "Overcrowded labs, outdated curriculum in some streams.",
    avgPackage: 7, highestPackage: 40, placementRate: 80, fees: 0.6,
    jeePercentileCutoff: 96,
    branches: ["CSE", "ECE", "EEE", "Mechanical", "Civil"],
    sentiment: { positive: 78, negative: 12, neutral: 10 }, tier: "best-fit",
    naacGrade: "A+", nirfRank: 0, establishedYear: 1965
  },
  {
    name: "JNTUH College of Engineering Sultanpur", code: "JNTUHCE", location: "Sultanpur, Sangareddy", district: "Sangareddy",
    type: "State", rating: 3.8, brochureRating: 4, realityRating: 3.5,
    realityReason: "Rural setting, limited placement opportunities compared to city.",
    bitterTruth: "Basic infrastructure, poor connectivity.",
    avgPackage: 4.5, highestPackage: 20, placementRate: 65, fees: 0.5,
    jeePercentileCutoff: 90,
    branches: ["CSE", "ECE", "EEE", "Mechanical"],
    sentiment: { positive: 60, negative: 25, neutral: 15 }, tier: "safe",
    naacGrade: "A", establishedYear: 2006
  },
  {
    name: "University College of Engineering Osmania University", code: "UCEOU", location: "Hyderabad", district: "Hyderabad",
    type: "State", rating: 4.3, brochureRating: 4.4, realityRating: 4,
    realityReason: "Prestigious college under OU, strong alumni.",
    bitterTruth: "Aging infrastructure, bureaucratic delays.",
    avgPackage: 6.5, highestPackage: 35, placementRate: 78, fees: 0.5,
    jeePercentileCutoff: 95,
    branches: ["CSE", "ECE", "EEE", "Mechanical", "Civil"],
    sentiment: { positive: 80, negative: 10, neutral: 10 }, tier: "best-fit",
    naacGrade: "A+", establishedYear: 1929
  },
  {
    name: "University College of Engineering Kakatiya University", code: "UCEKU", location: "Warangal", district: "Hanamkonda",
    type: "State", rating: 3.9, brochureRating: 4, realityRating: 3.5,
    realityReason: "Regional reputation, affordable education.",
    bitterTruth: "Placements mostly in local companies.",
    avgPackage: 5, highestPackage: 25, placementRate: 70, fees: 0.5,
    jeePercentileCutoff: 90,
    branches: ["CSE", "ECE", "EEE", "Mechanical", "Civil"],
    sentiment: { positive: 65, negative: 20, neutral: 15 }, tier: "safe",
    naacGrade: "A", establishedYear: 1972
  },
  {
    name: "Anurag University", code: "AU", location: "Ghatkesar, Medchal", district: "Medchal-Malkajgiri",
    type: "Deemed", rating: 4, brochureRating: 4.3, realityRating: 3.8,
    realityReason: "Good infrastructure, decent placements in IT.",
    bitterTruth: "Expensive fees, strict dress code.",
    avgPackage: 6, highestPackage: 45, placementRate: 85, fees: 1.8,
    jeePercentileCutoff: 85,
    branches: ["CSE", "AI", "DS", "ECE", "Mechanical", "Civil"],
    sentiment: { positive: 75, negative: 15, neutral: 10 }, tier: "best-fit",
    naacGrade: "A", nirfRank: 150, establishedYear: 2005
  },
  {
    name: "Mahindra University", code: "MU", location: "Bahadurpally, Hyderabad", district: "Medchal-Malkajgiri",
    type: "Private", rating: 4.5, brochureRating: 4.5, realityRating: 4.3,
    realityReason: "Industry-linked curriculum, modern labs.",
    bitterTruth: "High fees, relatively new.",
    avgPackage: 8, highestPackage: 60, placementRate: 85, fees: 3.5,
    jeePercentileCutoff: 80,
    branches: ["CSE", "AI", "Mech", "Civil", "ECE"],
    sentiment: { positive: 82, negative: 10, neutral: 8 }, tier: "best-fit",
    naacGrade: "A", establishedYear: 2014
  },
  {
    name: "Malla Reddy University", code: "MRU", location: "Maisammaguda, Hyderabad", district: "Medchal-Malkajgiri",
    type: "Private", rating: 3.5, brochureRating: 3.8, realityRating: 3.2,
    realityReason: "Mass recruitments in service companies.",
    bitterTruth: "Management focused on numbers over quality.",
    avgPackage: 4.5, highestPackage: 25, placementRate: 75, fees: 1.5,
    jeePercentileCutoff: 75,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 60, negative: 25, neutral: 15 }, tier: "safe",
    naacGrade: "A", establishedYear: 2020
  },
  {
    name: "Woxsen University", code: "WU", location: "Kamkole, Sangareddy", district: "Sangareddy",
    type: "Private", rating: 4, brochureRating: 4.5, realityRating: 3.8,
    realityReason: "Global collaborations, good for business/tech.",
    bitterTruth: "Expensive, engineering still evolving.",
    avgPackage: 7, highestPackage: 40, placementRate: 80, fees: 4,
    jeePercentileCutoff: 75,
    branches: ["CSE", "AI", "Data Science"],
    sentiment: { positive: 75, negative: 15, neutral: 10 }, tier: "best-fit",
    naacGrade: "A", establishedYear: 2014
  ...
  {
    name: "ICFAI Foundation for Higher Education", code: "ICFAI", location: "Hyderabad", district: "Hyderabad",
    type: "Deemed", rating: 3.8, brochureRating: 4, realityRating: 3.5,
    realityReason: "Management-focused, decent tech placements.",
    bitterTruth: "Engineering not flagship; placement support is average.",
    avgPackage: 5.5, highestPackage: 30, placementRate: 75, fees: 2,
    jeePercentileCutoff: 80,
    branches: ["CSE", "ECE", "Mech"],
    sentiment: { positive: 68, negative: 18, neutral: 14 }, tier: "best-fit",
    naacGrade: "A+", nirfRank: 40, establishedYear: 1984
  },
  {
    name: "Chaitanya Bharathi Institute of Technology", code: "CBIT", location: "Gandipet, Hyderabad", district: "Rangareddy",
    type: "Private", rating: 4.3, brochureRating: 4.5, realityRating: 4.2,
    realityReason: "Top private college in Telangana, excellent placements.",
    bitterTruth: "Strict rules, isolated campus, expensive for management quota.",
    avgPackage: 8, highestPackage: 55, placementRate: 90, fees: 1.5,
    jeePercentileCutoff: 90,
    branches: ["CSE", "AI", "DS", "ECE", "EEE", "Mech", "Civil", "IT"],
    sentiment: { positive: 85, negative: 8, neutral: 7 }, tier: "best-fit",
    naacGrade: "A+", nirfRank: 124, establishedYear: 1979
  },
  {
    name: "VNR Vignana Jyothi Institute of Engineering and Technology", code: "VNRVJIET", location: "Bachupally, Hyderabad", district: "Medchal-Malkajgiri",
    type: "Private", rating: 4.2, brochureRating: 4.3, realityRating: 4,
    realityReason: "Good placements, active coding culture.",
    bitterTruth: "Crowded, high fee hike each year.",
    avgPackage: 7, highestPackage: 50, placementRate: 88, fees: 1.6,
    jeePercentileCutoff: 88,
    branches: ["CSE", "AI", "DS", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 80, negative: 10, neutral: 10 }, tier: "best-fit",
    naacGrade: "A++", nirfRank: 135, establishedYear: 1995
  },
  {
    name: "Vasavi College of Engineering", code: "VCE", location: "Hyderabad", district: "Hyderabad",
    type: "Private", rating: 4.2, brochureRating: 4.3, realityRating: 4,
    realityReason: "Old, reputed college, strong alumni network.",
    bitterTruth: "Small campus, limited sports facilities.",
    avgPackage: 7.5, highestPackage: 52, placementRate: 87, fees: 1.4,
    jeePercentileCutoff: 88,
    branches: ["CSE", "IT", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 82, negative: 9, neutral: 9 }, tier: "best-fit",
    naacGrade: "A++", nirfRank: 150, establishedYear: 1981
  },
  {
    name: "Mahatma Gandhi Institute of Technology", code: "MGIT", location: "Hyderabad", district: "Hyderabad",
    type: "Private", rating: 4, brochureRating: 4.1, realityRating: 3.8,
    realityReason: "Consistent placements, good for ECE/CSE.",
    bitterTruth: "Strict discipline, attendance pressure.",
    avgPackage: 6.5, highestPackage: 45, placementRate: 85, fees: 1.3,
    jeePercentileCutoff: 85,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil", "IT"],
    sentiment: { positive: 76, negative: 14, neutral: 10 }, tier: "best-fit",
    naacGrade: "A", establishedYear: 1997
  },
  {
    name: "CVR College of Engineering", code: "CVR", location: "Ibrahimpatnam, Rangareddy", district: "Rangareddy",
    type: "Private", rating: 4, brochureRating: 4.2, realityRating: 3.8,
    realityReason: "Active placement cell, good infrastructure.",
    bitterTruth: "Remote location, transportation issues.",
    avgPackage: 6.5, highestPackage: 48, placementRate: 85, fees: 1.4,
    jeePercentileCutoff: 85,
    branches: ["CSE", "AI", "DS", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 78, negative: 13, neutral: 9 }, tier: "best-fit",
    naacGrade: "A", nirfRank: 170, establishedYear: 2001
  },
  {
    name: "Institute of Aeronautical Engineering", code: "IARE", location: "Dundigal, Hyderabad", district: "Medchal-Malkajgiri",
    type: "Private", rating: 3.8, brochureRating: 4.1, realityRating: 3.6,
    realityReason: "Specialized in aeronautics, but IT placements dominate.",
    bitterTruth: "Aeronautical jobs are rare; mostly service companies recruit.",
    avgPackage: 5.5, highestPackage: 35, placementRate: 80, fees: 1.3,
    jeePercentileCutoff: 80,
    branches: ["Aeronautical", "CSE", "ECE", "Mech", "Civil"],
    sentiment: { positive: 70, negative: 18, neutral: 12 }, tier: "best-fit",
    naacGrade: "A", establishedYear: 2000
  },
  {
    name: "B V Raju Institute of Technology", code: "BVRIT", location: "Narsapur, Medak", district: "Medak",
    type: "Private", rating: 4, brochureRating: 4.2, realityRating: 3.8,
    realityReason: "Good placements for a rural college.",
    bitterTruth: "Campus far from city, limited exposure.",
    avgPackage: 6, highestPackage: 45, placementRate: 82, fees: 1.3,
    jeePercentileCutoff: 82,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 74, negative: 16, neutral: 10 }, tier: "best-fit",
    naacGrade: "A", establishedYear: 1997
  },
  {
    name: "Vardhaman College of Engineering", code: "VARD", location: "Shamshabad, Hyderabad", district: "Rangareddy",
    type: "Private", rating: 3.9, brochureRating: 4, realityRating: 3.7,
    realityReason: "Decent infrastructure, improving placements.",
    bitterTruth: "Located near airport; noise and travel issues.",
    avgPackage: 5.5, highestPackage: 38, placementRate: 80, fees: 1.2,
    jeePercentileCutoff: 80,
    branches: ["CSE", "AI", "DS", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 72, negative: 18, neutral: 10 }, tier: "best-fit",
    naacGrade: "A+", establishedYear: 1999
  },
  {
    name: "Muffakham Jah College of Engineering and Technology", code: "MJCET", location: "Hyderabad", district: "Hyderabad",
    type: "Private", rating: 3.9, brochureRating: 4, realityRating: 3.8,
    realityReason: "Cultural diversity, decent engineering education.",
    bitterTruth: "Campus small, placements average.",
    avgPackage: 5.5, highestPackage: 40, placementRate: 78, fees: 1.2,
    jeePercentileCutoff: 82,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil", "IT"],
    sentiment: { positive: 73, negative: 14, neutral: 13 }, tier: "best-fit",
    naacGrade: "A", establishedYear: 1980
  },
  {
    name: "Keshav Memorial Engineering College", code: "KMEC", location: "Hyderabad", district: "Hyderabad",
    type: "Private", rating: 3.7, brochureRating: 3.8, realityRating: 3.5,
    realityReason: "Old college, affordable fees.",
    bitterTruth: "Outdated curriculum, low placement ratio.",
    avgPackage: 4, highestPackage: 25, placementRate: 65, fees: 0.9,
    jeePercentileCutoff: 75,
    branches: ["CSE", "ECE", "EEE", "Mech"],
    sentiment: { positive: 60, negative: 25, neutral: 15 }, tier: "safe",
    naacGrade: "B+", establishedYear: 1989
  },
  {
    name: "Kakatiya Institute of Technology and Science", code: "KITS", location: "Warangal", district: "Hanamkonda",
    type: "Private", rating: 3.9, brochureRating: 4, realityRating: 3.7,
    realityReason: "Regional respect, decent placements for locals.",
    bitterTruth: "Limited industry connections beyond Warangal.",
    avgPackage: 5.5, highestPackage: 35, placementRate: 75, fees: 1.1,
    jeePercentileCutoff: 80,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 68, negative: 20, neutral: 12 }, tier: "best-fit",
    naacGrade: "A", establishedYear: 1980
  },
  {
    name: "Sreenidhi Institute of Science and Technology", code: "SNIST", location: "Ghatkesar, Hyderabad", district: "Medchal-Malkajgiri",
    type: "Private", rating: 4, brochureRating: 4.2, realityRating: 3.9,
    realityReason: "Good campus, active placement cell.",
    bitterTruth: "Congested during placements, strict dress code.",
    avgPackage: 7, highestPackage: 50, placementRate: 85, fees: 1.5,
    jeePercentileCutoff: 85,
    branches: ["CSE", "AI", "DS", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 80, negative: 11, neutral: 9 }, tier: "best-fit",
    naacGrade: "A+", nirfRank: 150, establishedYear: 1997
  },
  {
    name: "Gokaraju Rangaraju Institute of Engineering and Technology", code: "GRIET", location: "Hyderabad", district: "Hyderabad",
    type: "Private", rating: 4.2, brochureRating: 4.3, realityRating: 4,
    realityReason: "Strong in CSE/IT, high placements.",
    bitterTruth: "Heavy coursework, attendance strict.",
    avgPackage: 8, highestPackage: 60, placementRate: 90, fees: 1.6,
    jeePercentileCutoff: 90,
    branches: ["CSE", "AI", "DS", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 84, negative: 8, neutral: 8 }, tier: "best-fit",
    naacGrade: "A+", nirfRank: 133, establishedYear: 1997
  },
  {
    name: "CMR Institute of Technology", code: "CMRIT", location: "Medchal, Hyderabad", district: "Medchal-Malkajgiri",
    type: "Private", rating: 4, brochureRating: 4.2, realityRating: 3.8,
    realityReason: "Good placements, good infrastructure.",
    bitterTruth: "Rapid expansion sometimes dilutes quality.",
    avgPackage: 7, highestPackage: 55, placementRate: 85, fees: 1.6,
    jeePercentileCutoff: 88,
    branches: ["CSE", "AI", "DS", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 79, negative: 12, neutral: 9 }, tier: "best-fit",
    naacGrade: "A+", nirfRank: 150, establishedYear: 2005
  },
  {
    name: "CMR Technical Campus", code: "CMRTC", location: "Medchal, Hyderabad", district: "Medchal-Malkajgiri",
    type: "Private", rating: 3.8, brochureRating: 4, realityRating: 3.6,
    realityReason: "Affiliated to JNTUH, decent placements.",
    bitterTruth: "Under CMR group, but lower priority than CMRIT.",
    avgPackage: 5.5, highestPackage: 40, placementRate: 80, fees: 1.3,
    jeePercentileCutoff: 80,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 70, negative: 20, neutral: 10 }, tier: "safe",
    naacGrade: "A", establishedYear: 2009
  },
  {
    name: "Geethanjali College of Engineering and Technology", code: "GCET", location: "Keesara, Hyderabad", district: "Medchal-Malkajgiri",
    type: "Private", rating: 3.7, brochureRating: 3.9, realityRating: 3.5,
    realityReason: "Affordable, average placements.",
    bitterTruth: "Management issues, student satisfaction low.",
    avgPackage: 4.5, highestPackage: 30, placementRate: 70, fees: 1.1,
    jeePercentileCutoff: 75,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 62, negative: 25, neutral: 13 }, tier: "safe",
    naacGrade: "A", establishedYear: 2005
  },
  {
    name: "Guru Nanak Institutions Technical Campus", code: "GNITC", location: "Ibrahimpatnam, Hyderabad", district: "Rangareddy",
    type: "Private", rating: 3.8, brochureRating: 4, realityRating: 3.6,
    realityReason: "Good infrastructure, decent faculty.",
    bitterTruth: "Remote location, bus transport issues.",
    avgPackage: 5.5, highestPackage: 35, placementRate: 75, fees: 1.2,
    jeePercentileCutoff: 80,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 68, negative: 20, neutral: 12 }, tier: "safe",
    naacGrade: "A", establishedYear: 2001
  },
  {
    name: "Guru Nanak Institute of Technology", code: "GNIT", location: "Hyderabad", district: "Hyderabad",
    type: "Private", rating: 3.8, brochureRating: 4, realityRating: 3.6,
    realityReason: "Placements improving, active student clubs.",
    bitterTruth: "Old campus, maintenance needed.",
    avgPackage: 5.5, highestPackage: 35, placementRate: 75, fees: 1.2,
    jeePercentileCutoff: 80,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 68, negative: 20, neutral: 12 }, tier: "safe",
  ...
  {
    name: "Malla Reddy Engineering College", code: "MREC", location: "Maisammaguda, Hyderabad", district: "Medchal-Malkajgiri",
    type: "Private", rating: 3.6, brochureRating: 3.9, realityRating: 3.3,
    realityReason: "Mass placement drives, mostly service companies.",
    bitterTruth: "High fees, quality varies between branches.",
    avgPackage: 5, highestPackage: 30, placementRate: 80, fees: 1.5,
    jeePercentileCutoff: 75,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 65, negative: 24, neutral: 11 }, tier: "safe",
    naacGrade: "A", establishedYear: 2002
  },
  {
    name: "Malla Reddy College of Engineering and Technology", code: "MRCET", location: "Maisammaguda, Hyderabad", district: "Medchal-Malkajgiri",
    type: "Private", rating: 3.6, brochureRating: 3.8, realityRating: 3.3,
    realityReason: "Similar to MREC, large intake.",
    bitterTruth: "Focus on quantity over quality.",
    avgPackage: 4.8, highestPackage: 28, placementRate: 78, fees: 1.4,
    jeePercentileCutoff: 75,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 63, negative: 27, neutral: 10 }, tier: "safe",
    naacGrade: "A", establishedYear: 2005
  },
  {
    name: "Malla Reddy Institute of Engineering and Technology", code: "MRIET", location: "Maisammaguda, Hyderabad", district: "Medchal-Malkajgiri",
    type: "Private", rating: 3.5, brochureRating: 3.8, realityRating: 3.2,
    realityReason: "Decent labs, placement support is average.",
    bitterTruth: "Part of large group, individual attention low.",
    avgPackage: 4.5, highestPackage: 25, placementRate: 75, fees: 1.2,
    jeePercentileCutoff: 70,
    branches: ["CSE", "ECE", "EEE", "Mech"],
    sentiment: { positive: 60, negative: 28, neutral: 12 }, tier: "safe",
    naacGrade: "B+", establishedYear: 2009
  },
  {
    name: "Malla Reddy Institute of Technology and Science", code: "MRITS", location: "Maisammaguda, Hyderabad", district: "Medchal-Malkajgiri",
    type: "Private", rating: 3.5, brochureRating: 3.7, realityRating: 3.2,
    realityReason: "Standard group college, decent placements.",
    bitterTruth: "Can feel like a degree factory.",
    avgPackage: 4.5, highestPackage: 25, placementRate: 75, fees: 1.2,
    jeePercentileCutoff: 70,
    branches: ["CSE", "ECE", "EEE", "Mech"],
    sentiment: { positive: 60, negative: 28, neutral: 12 }, tier: "safe",
    naacGrade: "B+", establishedYear: 2008
  },
  {
    name: "Malla Reddy Engineering College for Women", code: "MRECW", location: "Maisammaguda, Hyderabad", district: "Medchal-Malkajgiri",
    type: "Private", rating: 3.7, brochureRating: 4, realityRating: 3.5,
    realityReason: "Safe campus, encouraging environment for women.",
    bitterTruth: "Limited branch options, placements similar to co-ed counterparts.",
    avgPackage: 5, highestPackage: 30, placementRate: 78, fees: 1.4,
    jeePercentileCutoff: 75,
    branches: ["CSE", "ECE", "EEE", "IT"],
    sentiment: { positive: 70, negative: 18, neutral: 12 }, tier: "safe",
    naacGrade: "A", establishedYear: 2008
  },
  {
    name: "Marri Laxman Reddy Institute of Technology and Management", code: "MLRITM", location: "Dundigal, Hyderabad", district: "Medchal-Malkajgiri",
    type: "Private", rating: 3.8, brochureRating: 4, realityRating: 3.6,
    realityReason: "Growing infrastructure, decent placements.",
    bitterTruth: "Far from city, transport limited.",
    avgPackage: 5.5, highestPackage: 35, placementRate: 78, fees: 1.3,
    jeePercentileCutoff: 80,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 70, negative: 20, neutral: 10 }, tier: "safe",
    naacGrade: "A", establishedYear: 2009
  ...
  {
    name: "Aurora's Technological and Research Institute", code: "ATRI", location: "Hyderabad", district: "Hyderabad",
    type: "Private", rating: 3.7, brochureRating: 3.9, realityRating: 3.5,
    realityReason: "Old private college, decent CSE placements.",
    bitterTruth: "Campus maintenance issues, low core placements.",
    avgPackage: 5, highestPackage: 32, placementRate: 72, fees: 1.1,
    jeePercentileCutoff: 75,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 65, negative: 23, neutral: 12 }, tier: "safe",
    naacGrade: "A", establishedYear: 1999
  },
  {
    name: "Aurora's Scientific Technological and Research Academy", code: "ASTRA", location: "Hyderabad", district: "Hyderabad",
    type: "Private", rating: 3.7, brochureRating: 3.9, realityRating: 3.5,
    realityReason: "Similar to ATRI, Aurora group college.",
    bitterTruth: "Confusion between multiple Aurora campuses.",
    avgPackage: 5, highestPackage: 30, placementRate: 70, fees: 1.1,
    jeePercentileCutoff: 75,
    branches: ["CSE", "ECE", "EEE", "Mech"],
    sentiment: { positive: 65, negative: 23, neutral: 12 }, tier: "safe",
    naacGrade: "A", establishedYear: 2001
  ...
  {
    name: "Vignan Institute of Technology and Science", code: "VITS", location: "Deshmukhi, Nalgonda", district: "Yadadri-Bhuvanagiri",
    type: "Private", rating: 3.8, brochureRating: 4, realityRating: 3.6,
    realityReason: "Vignan group reputation, decent placements.",
    bitterTruth: "Rural setting, hostel food complaints.",
    avgPackage: 5.5, highestPackage: 35, placementRate: 78, fees: 1.3,
    jeePercentileCutoff: 80,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 70, negative: 20, neutral: 10 }, tier: "safe",
  ...
  {
    name: "Vignana Bharathi Institute of Technology", code: "VBIT", location: "Ghatkesar, Hyderabad", district: "Medchal-Malkajgiri",
    type: "Private", rating: 3.7, brochureRating: 3.9, realityRating: 3.5,
    realityReason: "Affordable, adequate placements.",
    bitterTruth: "Campus infrastructure dated.",
    avgPackage: 5, highestPackage: 30, placementRate: 72, fees: 1.1,
    jeePercentileCutoff: 75,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 65, negative: 23, neutral: 12 }, tier: "safe",
    naacGrade: "A", establishedYear: 1998
  },
  {
    name: "Vidya Jyothi Institute of Technology", code: "VJIT", location: "Hyderabad", district: "Hyderabad",
    type: "Private", rating: 3.9, brochureRating: 4.1, realityRating: 3.7,
    realityReason: "Good for CSE, active placement cell.",
    bitterTruth: "Campus small, congested during fests.",
    avgPackage: 6, highestPackage: 40, placementRate: 80, fees: 1.4,
    jeePercentileCutoff: 82,
    branches: ["CSE", "AI", "DS", "ECE", "EEE", "Mech"],
    sentiment: { positive: 74, negative: 16, neutral: 10 }, tier: "best-fit",
    naacGrade: "A", establishedYear: 1998
  },
  {
    name: "Holy Mary Institute of Technology and Science", code: "HMITS", location: "Hyderabad", district: "Rangareddy",
    type: "Private", rating: 3.5, brochureRating: 3.7, realityRating: 3.3,
    realityReason: "Minority institution, average academics.",
    bitterTruth: "Placement record inconsistent.",
    avgPackage: 4, highestPackage: 25, placementRate: 65, fees: 1,
    jeePercentileCutoff: 70,
    branches: ["CSE", "ECE", "EEE", "Mech"],
    sentiment: { positive: 58, negative: 28, neutral: 14 }, tier: "safe",
    naacGrade: "B+", establishedYear: 2002
  },
  {
    name: "Anurag Engineering College", code: "AEC", location: "Kodad, Suryapet", district: "Suryapet",
    type: "Private", rating: 3.6, brochureRating: 3.8, realityRating: 3.4,
    realityReason: "Rural college, low placement penetration.",
    bitterTruth: "Limited industry connect.",
    avgPackage: 4.5, highestPackage: 28, placementRate: 68, fees: 1,
    jeePercentileCutoff: 70,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 60, negative: 26, neutral: 14 }, tier: "safe",
    naacGrade: "B+", establishedYear: 2001
  },
  {
    name: "ACE Engineering College", code: "ACE", location: "Ghatkesar, Hyderabad", district: "Medchal-Malkajgiri",
    type: "Private", rating: 3.8, brochureRating: 4, realityRating: 3.6,
    realityReason: "Good infrastructure, decent CSE placements.",
    bitterTruth: "Far from city center, high fees.",
    avgPackage: 5.5, highestPackage: 35, placementRate: 78, fees: 1.3,
    jeePercentileCutoff: 80,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 70, negative: 19, neutral: 11 }, tier: "best-fit",
    naacGrade: "A", establishedYear: 2005
  },
  {
    name: "AAR Mahaveer Engineering College", code: "AARMEC", location: "Hyderabad", district: "Rangareddy",
    type: "Private", rating: 3.5, brochureRating: 3.7, realityRating: 3.2,
    realityReason: "Small college, limited placements.",
    bitterTruth: "Facilities below par.",
    avgPackage: 4, highestPackage: 22, placementRate: 60, fees: 0.9,
    jeePercentileCutoff: 65,
    branches: ["CSE", "ECE", "EEE", "Mech"],
    sentiment: { positive: 55, negative: 30, neutral: 15 }, tier: "safe",
    naacGrade: "B", establishedYear: 2003
  },
  {
    name: "Balaji Institute of Technology and Science", code: "BITS", location: "Warangal", district: "Hanamkonda",
    type: "Private", rating: 3.7, brochureRating: 3.9, realityRating: 3.5,
    realityReason: "Old private college in Warangal, decent local reputation.",
    bitterTruth: "Placements mostly in smaller companies.",
    avgPackage: 5, highestPackage: 30, placementRate: 70, fees: 1.1,
    jeePercentileCutoff: 75,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 65, negative: 22, neutral: 13 }, tier: "safe",
    naacGrade: "A", establishedYear: 2001
  },
  {
    name: "Nalla Malla Reddy Engineering College", code: "NMREC", location: "Ghatkesar, Hyderabad", district: "Medchal-Malkajgiri",
    type: "Private", rating: 3.7, brochureRating: 3.9, realityRating: 3.5,
    realityReason: "Good infrastructure, placements moderate.",
    bitterTruth: "Distance from city, traffic.",
    avgPackage: 5.5, highestPackage: 35, placementRate: 75, fees: 1.3,
    jeePercentileCutoff: 75,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 68, negative: 21, neutral: 11 }, tier: "safe",
    naacGrade: "A", establishedYear: 2001
  },
  {
    name: "Nalla Narasimha Reddy Education Society Group of Institutions", code: "NNRESGI", location: "Ghatkesar, Hyderabad", district: "Medchal-Malkajgiri",
    type: "Private", rating: 3.6, brochureRating: 3.8, realityRating: 3.4,
    realityReason: "Group institution, adequate facilities.",
    bitterTruth: "Lacks individual identity.",
    avgPackage: 5, highestPackage: 30, placementRate: 72, fees: 1.2,
    jeePercentileCutoff: 70,
    branches: ["CSE", "ECE", "EEE", "Mech"],
    sentiment: { positive: 63, negative: 25, neutral: 12 }, tier: "safe",
    naacGrade: "A", establishedYear: 2009
  },
  {
    name: "Methodist College of Engineering and Technology", code: "MCET", location: "Hyderabad", district: "Hyderabad",
    type: "Private", rating: 3.6, brochureRating: 3.8, realityRating: 3.4,
    realityReason: "Affordable, decent faculty.",
    bitterTruth: "Campus small, outdated equipment.",
    avgPackage: 4.5, highestPackage: 30, placementRate: 68, fees: 1,
    jeePercentileCutoff: 70,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 62, negative: 24, neutral: 14 }, tier: "safe",
    naacGrade: "B+", establishedYear: 2000
  },
  {
    name: "Mahaveer Institute of Science and Technology", code: "MIST", location: "Hyderabad", district: "Hyderabad",
    type: "Private", rating: 3.5, brochureRating: 3.7, realityRating: 3.2,
    realityReason: "Basic engineering college.",
    bitterTruth: "Low industry exposure.",
    avgPackage: 4, highestPackage: 22, placementRate: 60, fees: 0.9,
    jeePercentileCutoff: 65,
    branches: ["CSE", "ECE", "EEE", "Mech"],
    sentiment: { positive: 55, negative: 30, neutral: 15 }, tier: "safe",
  ...
  {
    name: "Bharat Institute of Engineering and Technology", code: "BIET", location: "Hyderabad", district: "Rangareddy",
    type: "Private", rating: 3.6, brochureRating: 3.8, realityRating: 3.4,
    realityReason: "Long established, decent placement record.",
    bitterTruth: "Infrastructure aging.",
    avgPackage: 5, highestPackage: 32, placementRate: 72, fees: 1.2,
    jeePercentileCutoff: 75,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 65, negative: 23, neutral: 12 }, tier: "safe",
    naacGrade: "A", establishedYear: 2001
  ...
  {
    name: "Hyderabad Institute of Technology and Management", code: "HITAM", location: "Hyderabad", district: "Medchal-Malkajgiri",
    type: "Private", rating: 3.7, brochureRating: 3.9, realityRating: 3.5,
    realityReason: "Active placement cell, good for CSE.",
    bitterTruth: "Campus small, not much cultural life.",
    avgPackage: 5.5, highestPackage: 38, placementRate: 78, fees: 1.3,
    jeePercentileCutoff: 78,
    branches: ["CSE", "AI", "DS", "ECE", "EEE", "Mech"],
    sentiment: { positive: 70, negative: 19, neutral: 11 }, tier: "safe",
    naacGrade: "A", establishedYear: 2001
  },
  {
    name: "Siddhartha Institute of Engineering and Technology", code: "SIET", location: "Hyderabad", district: "Rangareddy",
    type: "Private", rating: 3.5, brochureRating: 3.7, realityRating: 3.3,
    realityReason: "Average academic performance.",
    bitterTruth: "Placements heavily dependent on mass recruiters.",
    avgPackage: 4, highestPackage: 25, placementRate: 65, fees: 1,
    jeePercentileCutoff: 68,
    branches: ["CSE", "ECE", "EEE", "Mech"],
    sentiment: { positive: 58, negative: 28, neutral: 14 }, tier: "safe",
    naacGrade: "B+", establishedYear: 1999
  },
  {
    name: "BVRIT College of Engineering for Women", code: "BVRITW", location: "Hyderabad", district: "Hyderabad",
    type: "Private", rating: 3.9, brochureRating: 4.1, realityRating: 3.8,
    realityReason: "Strong women-centric environment, good placements.",
    bitterTruth: "Limited branch choices, strict curfew.",
    avgPackage: 6, highestPackage: 42, placementRate: 82, fees: 1.4,
    jeePercentileCutoff: 82,
    branches: ["CSE", "ECE", "EEE", "IT"],
    sentiment: { positive: 78, negative: 13, neutral: 9 }, tier: "best-fit",
    naacGrade: "A", establishedYear: 2012
  },
  {
    name: "G Narayanamma Institute of Technology and Science", code: "GNITS", location: "Hyderabad", district: "Hyderabad",
    type: "Private", rating: 4, brochureRating: 4.2, realityRating: 3.9,
    realityReason: "Top women's college, very good placements.",
    bitterTruth: "Strict rules, fee on higher side.",
    avgPackage: 7, highestPackage: 50, placementRate: 88, fees: 1.6,
    jeePercentileCutoff: 88,
    branches: ["CSE", "AI", "DS", "ECE", "EEE", "IT"],
    sentiment: { positive: 83, negative: 9, neutral: 8 }, tier: "best-fit",
    naacGrade: "A+", nirfRank: 151, establishedYear: 1997
  },
  {
    name: "Stanley College of Engineering and Technology for Women", code: "SCETW", location: "Hyderabad", district: "Hyderabad",
    type: "Private", rating: 3.7, brochureRating: 3.9, realityRating: 3.5,
    realityReason: "Safe environment, decent academics.",
    bitterTruth: "Placements similar to co-ed tier 3 colleges.",
    avgPackage: 5, highestPackage: 30, placementRate: 72, fees: 1.2,
    jeePercentileCutoff: 75,
    branches: ["CSE", "ECE", "EEE", "IT"],
    sentiment: { positive: 68, negative: 20, neutral: 12 }, tier: "safe",
  ...
  {
    name: "Anurag College of Engineering for Women", code: "ACEW", location: "Ghatkesar, Hyderabad", district: "Medchal-Malkajgiri",
    type: "Private", rating: 3.6, brochureRating: 3.8, realityRating: 3.4,
    realityReason: "Part of Anurag group, average placements.",
    bitterTruth: "Rural setting, transport issues.",
    avgPackage: 4.5, highestPackage: 28, placementRate: 68, fees: 1.2,
    jeePercentileCutoff: 70,
    branches: ["CSE", "ECE", "EEE"],
    sentiment: { positive: 63, negative: 24, neutral: 13 }, tier: "safe",
    naacGrade: "B+", establishedYear: 2009
  },
  {
    name: "Ellenki College of Engineering and Technology", code: "ECET", location: "Hyderabad", district: "Medchal-Malkajgiri",
    type: "Private", rating: 3.5, brochureRating: 3.7, realityRating: 3.2,
    realityReason: "Basic college, low placements.",
    bitterTruth: "Poor infrastructure.",
    avgPackage: 3.5, highestPackage: 20, placementRate: 55, fees: 0.9,
    jeePercentileCutoff: 60,
    branches: ["CSE", "ECE", "EEE", "Mech"],
    sentiment: { positive: 50, negative: 35, neutral: 15 }, tier: "safe",
    naacGrade: "B", establishedYear: 2004
  },
  {
    name: "Siddhartha Institute of Engineering and Technology for Women", code: "SIETW", location: "Hyderabad", district: "Rangareddy",
    type: "Private", rating: 3.5, brochureRating: 3.7, realityRating: 3.2,
    realityReason: "Women's college, safety focus.",
    bitterTruth: "Limited exposure, mass recruitment.",
    avgPackage: 4, highestPackage: 25, placementRate: 62, fees: 1,
    jeePercentileCutoff: 65,
    branches: ["CSE", "ECE", "EEE"],
    sentiment: { positive: 57, negative: 28, neutral: 15 }, tier: "safe",
    naacGrade: "B+", establishedYear: 2009
  },
  {
    name: "Swarna Bharathi Institute of Science and Technology", code: "SBIST", location: "Khammam", district: "Khammam",
    type: "Private", rating: 3.5, brochureRating: 3.7, realityRating: 3.2,
    realityReason: "Regional college, average placements.",
    bitterTruth: "Remote location, few core companies visit.",
    avgPackage: 3.5, highestPackage: 22, placementRate: 60, fees: 0.9,
    jeePercentileCutoff: 60,
    branches: ["CSE", "ECE", "EEE", "Mech"],
    sentiment: { positive: 54, negative: 30, neutral: 16 }, tier: "safe",
    naacGrade: "B", establishedYear: 2003
  },
  {
    name: "Deccan College of Engineering and Technology", code: "DCET", location: "Hyderabad", district: "Hyderabad",
    type: "Private", rating: 3.5, brochureRating: 3.7, realityRating: 3.3,
    realityReason: "Old college, minority status benefits.",
    bitterTruth: "Placements inconsistent.",
    avgPackage: 4.5, highestPackage: 28, placementRate: 65, fees: 1,
    jeePercentileCutoff: 70,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 60, negative: 25, neutral: 15 }, tier: "safe",
    naacGrade: "B+", establishedYear: 1984
  },
  {
    name: "Lords Institute of Engineering and Technology", code: "LIET", location: "Hyderabad", district: "Rangareddy",
    type: "Private", rating: 3.6, brochureRating: 3.8, realityRating: 3.4,
    realityReason: "Decent infrastructure, minority quota.",
    bitterTruth: "Placement drives mostly mass recruiters.",
    avgPackage: 4.5, highestPackage: 30, placementRate: 68, fees: 1.1,
    jeePercentileCutoff: 72,
    branches: ["CSE", "ECE", "EEE", "Mech"],
    sentiment: { positive: 62, negative: 24, neutral: 14 }, tier: "safe",
    naacGrade: "A", establishedYear: 2002
  },
  {
    name: "ISL Engineering College", code: "ISLEC", location: "Hyderabad", district: "Hyderabad",
    type: "Private", rating: 3.5, brochureRating: 3.7, realityRating: 3.2,
    realityReason: "Minority institution, low fees.",
    bitterTruth: "Very basic facilities.",
    avgPackage: 3.5, highestPackage: 20, placementRate: 55, fees: 0.9,
    jeePercentileCutoff: 60,
    branches: ["CSE", "ECE", "EEE"],
    sentiment: { positive: 52, negative: 32, neutral: 16 }, tier: "safe",
    naacGrade: "B", establishedYear: 2004
  },
  {
    name: "Shadan College of Engineering and Technology", code: "SCET", location: "Hyderabad", district: "Hyderabad",
    type: "Private", rating: 3.5, brochureRating: 3.7, realityRating: 3.2,
    realityReason: "Affordable, minority quota.",
    bitterTruth: "Management issues, poor placement record.",
    avgPackage: 3.5, highestPackage: 20, placementRate: 50, fees: 0.9,
    jeePercentileCutoff: 60,
    branches: ["CSE", "ECE", "EEE"],
    sentiment: { positive: 50, negative: 34, neutral: 16 }, tier: "safe",
    naacGrade: "B", establishedYear: 2001
  },
  {
    name: "Nawab Shah Alam Khan College of Engineering and Technology", code: "NSAKCET", location: "Hyderabad", district: "Hyderabad",
    type: "Private", rating: 3.4, brochureRating: 3.6, realityRating: 3.1,
    realityReason: "Minority institution, low cost.",
    bitterTruth: "Placements negligible.",
    avgPackage: 3, highestPackage: 18, placementRate: 45, fees: 0.8,
    jeePercentileCutoff: 55,
    branches: ["CSE", "ECE", "EEE"],
    sentiment: { positive: 45, negative: 38, neutral: 17 }, tier: "safe",
    naacGrade: "B", establishedYear: 2005
  },
  {
    name: "Matrusri Engineering College", code: "MEC", location: "Hyderabad", district: "Hyderabad",
    type: "Private", rating: 3.6, brochureRating: 3.8, realityRating: 3.4,
    realityReason: "Old college, decent faculty.",
    bitterTruth: "Placements only for CSE/IT.",
    avgPackage: 4.5, highestPackage: 28, placementRate: 65, fees: 1,
    jeePercentileCutoff: 70,
    branches: ["CSE", "ECE", "EEE", "Mech"],
    sentiment: { positive: 60, negative: 25, neutral: 15 }, tier: "safe",
  ...
  {
    name: "Sreyas Institute of Engineering and Technology", code: "SIET", location: "Hyderabad", district: "Rangareddy",
    type: "Private", rating: 3.5, brochureRating: 3.7, realityRating: 3.2,
    realityReason: "Average academics, okay placements.",
    bitterTruth: "Campus not well maintained.",
    avgPackage: 4, highestPackage: 24, placementRate: 60, fees: 1,
    jeePercentileCutoff: 65,
    branches: ["CSE", "ECE", "EEE", "Mech"],
    sentiment: { positive: 55, negative: 30, neutral: 15 }, tier: "safe",
    naacGrade: "B+", establishedYear: 2002
  ...
  {
    name: "TKR College of Engineering and Technology", code: "TKRCET", location: "Hyderabad", district: "Rangareddy",
    type: "Private", rating: 3.6, brochureRating: 3.8, realityRating: 3.4,
    realityReason: "Good infrastructure, active placement cell.",
    bitterTruth: "Remote location.",
    avgPackage: 5, highestPackage: 32, placementRate: 72, fees: 1.2,
    jeePercentileCutoff: 75,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 65, negative: 22, neutral: 13 }, tier: "safe",
  ...
  {
    name: "CMR Engineering College", code: "CMREC", location: "Medchal, Hyderabad", district: "Medchal-Malkajgiri",
    type: "Private", rating: 3.9, brochureRating: 4.1, realityRating: 3.7,
    realityReason: "CMR group, decent placements.",
    bitterTruth: "Over-crowding, high fees.",
    avgPackage: 6, highestPackage: 45, placementRate: 82, fees: 1.5,
    jeePercentileCutoff: 85,
    branches: ["CSE", "AI", "DS", "ECE", "EEE", "Mech"],
    sentiment: { positive: 73, negative: 16, neutral: 11 }, tier: "best-fit",
    naacGrade: "A+", establishedYear: 2010
  },
  {
    name: "Kommuri Pratap Reddy Institute of Technology", code: "KPRIT", location: "Hyderabad", district: "Rangareddy",
    type: "Private", rating: 3.5, brochureRating: 3.7, realityRating: 3.2,
    realityReason: "Small college, limited placements.",
    bitterTruth: "No campus life.",
    avgPackage: 3.5, highestPackage: 22, placementRate: 55, fees: 0.9,
    jeePercentileCutoff: 60,
    branches: ["CSE", "ECE", "EEE"],
    sentiment: { positive: 50, negative: 33, neutral: 17 }, tier: "safe",
    naacGrade: "B", establishedYear: 2006
  },
  {
    name: "Jaya Prakash Narayan College of Engineering", code: "JPNCE", location: "Mahabubnagar", district: "Mahabubnagar",
    type: "Private", rating: 3.4, brochureRating: 3.6, realityRating: 3.1,
    realityReason: "Rural college, low placements.",
    bitterTruth: "Poor infrastructure, hardly any companies visit.",
    avgPackage: 3, highestPackage: 18, placementRate: 45, fees: 0.8,
    jeePercentileCutoff: 50,
    branches: ["CSE", "ECE", "EEE", "Mech"],
    sentiment: { positive: 43, negative: 40, neutral: 17 }, tier: "safe",
    naacGrade: "B", establishedYear: 2003
  },
  {
    name: "St Martin's Engineering College", code: "SMEC", location: "Hyderabad", district: "Medchal-Malkajgiri",
    type: "Private", rating: 3.7, brochureRating: 3.9, realityRating: 3.5,
    realityReason: "Decent placements, good infrastructure.",
    bitterTruth: "Management strict, high fees.",
    avgPackage: 5.5, highestPackage: 35, placementRate: 75, fees: 1.4,
    jeePercentileCutoff: 78,
    branches: ["CSE", "AI", "DS", "ECE", "EEE", "Mech"],
    sentiment: { positive: 70, negative: 19, neutral: 11 }, tier: "safe",
    naacGrade: "A", establishedYear: 2003
  },
  {
    name: "Maturi Venkata Subba Rao Engineering College", code: "MVSREC", location: "Hyderabad", district: "Hyderabad",
    type: "Private", rating: 3.7, brochureRating: 3.9, realityRating: 3.5,
    realityReason: "Old college, decent placement history.",
    bitterTruth: "Campus infrastructure dated, traffic congestion.",
    avgPackage: 5, highestPackage: 32, placementRate: 70, fees: 1.2,
    jeePercentileCutoff: 75,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 65, negative: 23, neutral: 12 }, tier: "safe",
    naacGrade: "A", establishedYear: 1997
  ...
  {
    name: "Princeton Institute of Engineering and Technology for Women", code: "PIETW", location: "Hyderabad", district: "Medchal-Malkajgiri",
    type: "Private", rating: 3.6, brochureRating: 3.8, realityRating: 3.4,
    realityReason: "Safe campus, okay academics.",
    bitterTruth: "Placements similar to tier 3 colleges.",
    avgPackage: 4.5, highestPackage: 28, placementRate: 65, fees: 1.1,
    jeePercentileCutoff: 70,
    branches: ["CSE", "ECE", "EEE"],
    sentiment: { positive: 62, negative: 24, neutral: 14 }, tier: "safe",
    naacGrade: "B+", establishedYear: 2009
  ...
  {
    name: "Sphoorthy Engineering College", code: "SEC", location: "Hyderabad", district: "Rangareddy",
    type: "Private", rating: 3.7, brochureRating: 3.9, realityRating: 3.5,
    realityReason: "Good for CSE, decent placements.",
    bitterTruth: "Far from city, traffic.",
    avgPackage: 5.5, highestPackage: 35, placementRate: 75, fees: 1.3,
    jeePercentileCutoff: 75,
    branches: ["CSE", "AI", "DS", "ECE", "EEE", "Mech"],
    sentiment: { positive: 68, negative: 20, neutral: 12 }, tier: "safe",
    naacGrade: "A", establishedYear: 2004
  },
  {
    name: "Arjun College of Technology and Sciences", code: "ACTS", location: "Hyderabad", district: "Rangareddy",
    type: "Private", rating: 3.4, brochureRating: 3.6, realityRating: 3.1,
    realityReason: "Basic infrastructure, average placements.",
    bitterTruth: "Lack of industry exposure.",
    avgPackage: 3.5, highestPackage: 20, placementRate: 55, fees: 0.9,
    jeePercentileCutoff: 60,
    branches: ["CSE", "ECE", "EEE", "Mech"],
    sentiment: { positive: 50, negative: 34, neutral: 16 }, tier: "safe",
  ...
  {
    name: "Kakatiya University College of Engineering and Technology", code: "KUCET", location: "Warangal", district: "Hanamkonda",
    type: "State", rating: 3.8, brochureRating: 4, realityRating: 3.6,
    realityReason: "University campus, affordable.",
    bitterTruth: "Low placement ratio.",
    avgPackage: 4.5, highestPackage: 28, placementRate: 65, fees: 0.5,
    jeePercentileCutoff: 85,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 65, negative: 22, neutral: 13 }, tier: "safe",
    naacGrade: "A", establishedYear: 1976
  },
  {
    name: "Vaagdevi College of Engineering", code: "VCE", location: "Warangal", district: "Hanamkonda",
    type: "Private", rating: 3.6, brochureRating: 3.8, realityRating: 3.4,
    realityReason: "Old college, decent local reputation.",
    bitterTruth: "Placements not great for core branches.",
    avgPackage: 4.5, highestPackage: 30, placementRate: 68, fees: 1,
    jeePercentileCutoff: 70,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 62, negative: 25, neutral: 13 }, tier: "safe",
  ...
  {
    name: "Vaagdevi Engineering College", code: "VEC", location: "Warangal", district: "Hanamkonda",
    type: "Private", rating: 3.6, brochureRating: 3.8, realityRating: 3.4,
    realityReason: "Similar to Vaagdevi group, okay placements.",
    bitterTruth: "Campus outside city.",
    avgPackage: 4.5, highestPackage: 30, placementRate: 68, fees: 1,
    jeePercentileCutoff: 70,
    branches: ["CSE", "ECE", "EEE", "Mech"],
    sentiment: { positive: 62, negative: 25, neutral: 13 }, tier: "safe",
  ...
  {
    name: "SR Engineering College", code: "SREC", location: "Warangal", district: "Hanamkonda",
    type: "Private", rating: 3.7, brochureRating: 3.9, realityRating: 3.5,
    realityReason: "Active in placements, good infrastructure.",
    bitterTruth: "High fees, strict management.",
    avgPackage: 5.5, highestPackage: 35, placementRate: 75, fees: 1.3,
    jeePercentileCutoff: 75,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 68, negative: 21, neutral: 11 }, tier: "safe",
  ...
  {
    name: "Christu Jyothi Institute of Technology and Science", code: "CJITS", location: "Warangal", district: "Hanamkonda",
    type: "Private", rating: 3.6, brochureRating: 3.8, realityRating: 3.4,
    realityReason: "Christian minority college, good discipline.",
    bitterTruth: "Placements mostly mass recruiters.",
    avgPackage: 4.5, highestPackage: 30, placementRate: 68, fees: 1,
    jeePercentileCutoff: 70,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 63, negative: 24, neutral: 13 }, tier: "safe",
  ...
  {
    name: "Ganapathy Engineering College", code: "GEC", location: "Warangal", district: "Hanamkonda",
    type: "Private", rating: 3.5, brochureRating: 3.7, realityRating: 3.2,
    realityReason: "Affordable, basic facilities.",
    bitterTruth: "Very few placements.",
    avgPackage: 3.5, highestPackage: 20, placementRate: 50, fees: 0.8,
    jeePercentileCutoff: 55,
    branches: ["CSE", "ECE", "EEE", "Mech"],
    sentiment: { positive: 48, negative: 35, neutral: 17 }, tier: "safe",
    naacGrade: "B", establishedYear: 2005
  },
  {
    name: "Warangal Institute of Technology and Science", code: "WITS", location: "Warangal", district: "Hanamkonda",
    type: "Private", rating: 3.5, brochureRating: 3.7, realityRating: 3.2,
    realityReason: "Average academics, low placements.",
    bitterTruth: "Management not responsive.",
    avgPackage: 3.5, highestPackage: 20, placementRate: 50, fees: 0.9,
    jeePercentileCutoff: 55,
    branches: ["CSE", "ECE", "EEE", "Mech"],
    sentiment: { positive: 47, negative: 36, neutral: 17 }, tier: "safe",
    naacGrade: "B", establishedYear: 2008
  },
  {
    name: "Jayamukhi Institute of Technological Sciences", code: "JITS", location: "Warangal", district: "Hanamkonda",
    type: "Private", rating: 3.6, brochureRating: 3.8, realityRating: 3.4,
    realityReason: "Decent campus, okay placements.",
    bitterTruth: "Remote location, transport issues.",
    avgPackage: 4.5, highestPackage: 30, placementRate: 65, fees: 1.1,
    jeePercentileCutoff: 68,
    branches: ["CSE", "ECE", "EEE", "Mech", "Civil"],
    sentiment: { positive: 62, negative: 25, neutral: 13 }, tier: "safe",
    naacGrade: "A", establishedYear: 2001
